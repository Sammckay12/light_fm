...
from determineUsers.js import hello
...
#
# full_users = np.concatenate([users_data, virtual_users_data])
#
# full_ratings = np.concatenate([ratings_data, virtual_ratings_data])
#
#
...
#
#
# score = model.predict(21000,np.arange(num_items), user_features=user_features,item_features=item_features)
# print(repr(score))
